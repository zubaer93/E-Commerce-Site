					...
					<div class = "row">
						<div class="col-md-12">
							<div class = "well well-sm " >
								...
								<a href = 'checkout.php?order'><button class='btn btn-success'>ORDER NOW</button></a>
							</div>
						</div>
						...
						<div class='col-md-12'>
							<?php 
								...
								if(isset($_GET['add_cart'])){
									$ip = getIp();
									$cat_id = $_GET['add_cart'];
									$delete_product = mysqli_query($conn,"DELETE FROM cart where ip_address = '$ip' AND pro_id= '$cat_id'");
									if($delete_product){
									...
									{
										echo "<script>alert('Data could not be deleted. Please try again.')</script>";
									}
							
								}
								elseif(isset($_POST['up_cart'])){
									$ip = getIp();
									$quantity = $_POST['quantity'];
									$cat_id = $_POST['up_cart'];
									$update_product = mysqli_query($conn,"UPDATE cart SET quantity = '$quantity' where ip_address = '$ip' AND pro_id= '$cat_id'");
									if($update_product){
