			...
			<div class = "row">
				...
				<div class="col-md-9">
					<div class = "row">
						...
						<div class='col-md-12'>	
							<div class='well'>
								<p style = 'color:#00688B'>Please help us to progress and develop our site by providing your valuable feedback</p>
									<form method = 'post'>
										...
										<div class='form-group'>
											...
											<input type='name' name = 'country'class='form-control' id='country' required>
										</div>
										<div class='form-group'>
											<label style = 'color:#00688B' for='comment'>Comment:</label>
											<textarea class='form-control' name = 'comment' rows='5' id='comment' required></textarea>
										</div>	
										<button type='submit' class='btn btn-success' name = 'feedback'>Give your feedback</button>
									</form>
							</div>								
								<div class='row'>
									<?php
										$random_sql = "select * from feedback";
...
<?php
	if(isset($_POST["feedback"])){
			...
			$sql_query = "INSERT INTO feedback (name,country,comment) VALUES ('$name','$country','$comment')";
			...
			if($update_comment){
				...
				echo "<script>alert('Your feedback can not be processed now.')</script>";
			}			
		}
